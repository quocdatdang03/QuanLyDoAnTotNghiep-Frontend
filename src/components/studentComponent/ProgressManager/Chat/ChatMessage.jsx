  ...
  return (
    <div ref={currentMessageRef}>
      ...
      <div className={`flex ${isOwnMessage ? "justify-end" : "justify-start"}`}>
        ...
        >
          <img className="w-7 h-7 rounded-full" src={sender?.image} />
          <div className="flex flex-col">
            ...
            >
              ...
              <Chip label="Giai đoạn 1" variant="filled" size="small" />
            </div>
            {isRevokedMessage ? (
              // Revoked message
              <div
              ...
              >
                ...
                >
                  {/* div connector */}
                  <div
                    className={`absolute bottom-1/2 translate-y-1/2 w-5 h-6 opacity-0 ${
                      isOwnMessage ? "left-full" : "right-full"
                    } `}
                  ></div>
                  {isOwnMessage && (
                    <DeleteIcon
