              ...
              <AccordionDetails>
                <div className="ml-12 border-t border-gray-500 py-5 space-y-5">
                  {[1, 1].map((item, index) => {
                    return (
                      <div
                        className="flex gap-5 border p-3 rounded-md shadow-md bg-blue-50"
                        key={index}
                      >
                        <img
                          src={defaultAvatar}
                        ...
                        <div className="space-y-2">
                          ...
                          <p>
                            ...
                            <span className="text-justify">
                              ...
                              elit. Ipsa temporibus suscipit consectetur, quidem
                              asperiores eligendi facilis accusantium ex non
                              officia nulla totam laudantium itaque quis,
