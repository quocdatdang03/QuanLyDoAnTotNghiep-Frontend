...
import { updateAdminProfileAction } from "../../../redux/Auth/Action";
...
const FormUpdateProfile = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(updateAdminProfileAction(requestData));
  ...
  return (
    <form className="space-y-2 md:space-y-3" onSubmit={formik.handleSubmit}>
      ...
      <div className="flex items-center justify-center gap-3">
        ...
        <Button onClick={() => navigate("/admin/profile")}>Quay lại</Button>
      </div>
    </form>
  );
};
