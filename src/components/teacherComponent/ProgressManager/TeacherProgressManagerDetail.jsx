    ...
    <Container className="my-10 py-10" component={Paper}>
      ...
      <div className="mt-7">
        ...
        <div className="space-y-5 px-5">
          {instructorProgressReducer.project?.totalStages <
          instructorProgressReducer.project?.totalCreatedStages ? (
            <div className="bg-gray-100 px-5 py-10 rounded-md mt-5 text-center italic text-lg">
              <p className="mb-2">
                Sinh viên mới chưa được thêm giai đoạn, vui lòng quay lại trang
                quản lý tiến độ để thêm giai đoạn đã có cho sinh viên
              </p>
              <Button
                variant="contained"
                color="success"
